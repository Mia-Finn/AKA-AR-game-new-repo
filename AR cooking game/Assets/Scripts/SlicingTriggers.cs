...
public class SlicingTriggers : MonoBehaviour
{
    ...
    public GameObject lettuce, lettuceSlice, burger, burgerSlice, cheese, cheeseSlice, pepperSauce, pickle, pickleSlice, mushroom, mushroomSlice, bacon, baconSlice, onion, onionSlice;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        else if (knife8.activeInHierarchy == true)
        {
            ...
            pickleSlice.SetActive(true);
            pepperSauce.SetActive(true);
        }
    }
    }
